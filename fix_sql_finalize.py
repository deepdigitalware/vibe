...
def fix_sql_and_finalize():
    ...
    try:
        ...
        commands = [
            "echo '--- Updating Server User to root in Coolify DB (Fixed SQL) ---'",
            ...
            "echo '--- Restarting Coolify and Proxy ---'",
            "docker restart coolify coolify-proxy coolify-sentinel",
